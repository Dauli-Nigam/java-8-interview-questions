...
// TODO QUESTION 1 FIND THE STUDENT SECTION WISE...
...
public class StudentProgrammingQuestion {
    public static void main(String[] args) {
        ...
        Map<String, List<Student>> studentsBySection = studentList.stream().collect(Collectors.groupingBy(Student::getSection, Collectors.toList()));
        ...
        for (Map.Entry<String, List<Student>> entry : studentsBySection.entrySet()) {
            ...
            for (String key : studentsBySection.keySet()) {
                ...
                System.out.println("section By Students are " + studentsBySection.get(key));
            ...
            // TODO SECTION COUNT TOTAL NUMBER OF STUDENTS WITH SECTION B...

            long count = studentList.stream().filter(s -> s.getSection().equals("B")).count();
